...
if shared.vapewhitelist:get(lplr) == 0 then
	shared.vapewhitelist.customtags[lplr.Name] = {{text = '', color = Color3.new(1, 1, 0)}}
end
...
runFunction(function()
	...
	AutoRejoin = GuiLibrary.ObjectsThatCanBeSaved.AlanaOwnerWindow.Api.CreateOptionsButton({
		Name = "AutoRejoin",
...
pcall(function()
	local Rejoin = {}
	Rejoin = GuiLibrary.ObjectsThatCanBeSaved.AlanaOwnerWindow.Api.CreateOptionsButton({
		Name = 'Rejoin',
		Function = function(callback)
			if callback then
				Rejoin.ToggleButton()
